<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestionHieraClient.aspx.cs" Inherits="AGI.gestionHieraClient" %>
...
<asp:TreeView ID="TreeViewSideMenu" runat="server" BackColor ="#0f4396" Width ="295px" BorderStyle ="Solid" border-radius="10px"
    ...
    <div class ="row">
        <div class="col">
            ...
            <br/>
            <br/>
            <asp:Label ID="lblCtmFlw1" runat="server" Text="Customer Flow 1" class="lblInfo"></asp:Label>
            <br/>
            <asp:TextBox ID="tbxCtmFlw1" runat="server" class="tbxInfo">Customer Flow 1</asp:TextBox>
            <br/>
            <br/>
            <asp:Label ID="lblCtmFlw2" runat="server" Text="Libellé Potentiel Client" class="lblInfo"></asp:Label>
            <br/>
            <asp:DropDownList ID="ddlCtmFlw2" runat="server" Class="ddlInfo"></asp:DropDownList>    
            <br/>
            <br/>
            <br/>
            <br/>         
        ...
        <div class="col">
            ...
            <br/>
            <br/>
            <asp:Label ID="lblTSBusClas1" runat="server" Text="TS Business Classification Lev 1" class="lblInfo"></asp:Label>
            <br/>
            <asp:TextBox ID="tbxTSBusClas1" runat="server" class="tbxInfo">TS Business Classification Lev 1</asp:TextBox>
            <br/>
            <br/>
            <asp:Label ID="lblTSBusClas2" runat="server" Text="TS Business Classification Lev 2" class="lblInfo"></asp:Label>
            <br/>
            <asp:DropDownList ID="ddlTSBusClas2" runat="server" Class="ddlInfo"></asp:DropDownList>
            <br/>
            <br/>
            <br/>
            <br/>
