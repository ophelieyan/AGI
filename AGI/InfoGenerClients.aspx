<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InfoGenerClients.aspx.cs" Inherits="AGI.InfoGenerClients" %>
    ...
    <div class ="mainContent">
        <div class="row">
            ...
            <div class="col-lg-9">
               <div>
                    <ul id="tabnav">
                       <li class="active"><a href="InfoGenerClients">Infos Générales</a></li>
                       <li><a href="hierarchieclient">Hierarchie Clients</a></li>
                    </ul>
                </div>
                <br />
                <div class="row">
                ...
                <div class="col-lg-2" >
                    ...
                    <br />
                    <br />
                    <asp:Label ID="lblPotenType" runat="server" Text="Potentiel Type" Class="lblInfo"></asp:Label>
                    <br />
                    <asp:Label ID="lblCustmType" runat="server" Text="Customer Type" Class="lblInfo"></asp:Label>
                    <br />
                    <asp:Label ID="lblCustmStatuts" runat="server" Text="Customer Statuts" Class="lblInfo"></asp:Label>
                    <br />
                    <br />
                    <br />
                </div>  
                <div class="col-lg-4" >
                    ...
                    <br />
                    <br />
                    <asp:TextBox ID="tbxPotenType" runat="server" Class="tbxInfo"></asp:TextBox> 
                    <br />
                    <asp:TextBox ID="tbxCustmType" runat="server" Class="tbxInfo"></asp:TextBox>
                    <br/>
                    <asp:TextBox ID="tbxCustmStatuts" runat="server" Class="tbxInfo"></asp:TextBox>
                    <br />
                    <br />
                    <br />
               </div>
