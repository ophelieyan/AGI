<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestionClientsInfo.aspx.cs" Inherits="AGI.gestionClientsInfo" %>
...
<asp:TreeView ID="TreeViewSideMenu" runat="server" BackColor ="#0f4396" Width ="295px" BorderStyle ="Solid" border-radius="10px"
    ...
    <div class ="row">
        <div class="col">
            ...
            <br/>
            <br/>
            <asp:Label ID="lblCodClient" runat="server" Text="Code Client local" class="lblInfo"></asp:Label>
            <br/>
            <asp:TextBox ID="tbxCodClient" runat="server" class="tbxInfo">Code Client local</asp:TextBox>
            <br/>
            <br/>
        ...
        <div class="col">
            <br/>
            <br/>
            <asp:Label ID="lblContClient" runat="server" Text="Contact Client" class="lblInfo"></asp:Label>
            <br/>
            <asp:TextBox ID="tbxContClient" runat="server" class="tbxInfo">Contact Client</asp:TextBox>
            <br/>
            <br/>
            <asp:Label ID="lblNumTel" runat="server" Text="N° Téléphone" class="lblInfo"></asp:Label>
            <br/>
            <asp:TextBox ID="TbxNumTel" runat="server" class="tbxInfo">N° Téléphone</asp:TextBox>
            <br/>
            <br/>
            <asp:Label ID="lblEml" runat="server" Text="Email" class="lblInfo"></asp:Label>
            <br/>
            <asp:TextBox ID="txtEml" runat="server" class="tbxInfo" TextMode="Email" >Email</asp:TextBox>
            <br/>
            <br/>
            <asp:Label ID="lblRtchGroupe" runat="server" Text="Rattachement à un groupe y/n" class="lblInfo"></asp:Label>
            <br/>
            <asp:DropDownList ID="ddlRtchGroupe" runat="server" Class="ddlInfo"></asp:DropDownList>
            <br/>
            <br/>
            <asp:Label ID="lblPays" runat="server" Text="Pays" class="lblInfo"></asp:Label>
            <br/>
            <asp:TextBox ID="tbxPays" runat="server" class="tbxInfo">Pays</asp:TextBox>
            <br/>
            <br/>
        </div>
        <div class="col">
            <br/>
            <br/>
            <asp:Label ID="lblAds1" runat="server" Text="Adresse Champs 1" class="lblInfo"></asp:Label>
            <br/>
            <asp:TextBox ID="tbxAds1" runat="server" class="tbxInfo" Wrap="true"  TextMode="MultiLine" >Adresse Champs 1</asp:TextBox>
            <br/>
            <br/>
            <br/>
            <asp:Label ID="lblAds2" runat="server" Text="Adresse Champs 2" class="lblInfo"></asp:Label>
            <br/>
            <asp:TextBox ID="tbxAd2" runat="server" class="tbxInfo" Wrap="true" TextMode="MultiLine">Adresse Champs 2</asp:TextBox>
            <br />
            <br />
            <br />
            <br/>
