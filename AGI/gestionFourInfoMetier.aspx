<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestionFourInfoMetier.aspx.cs" Inherits="AGI.gestionFourInfoMetier" %>
...
<div class ="row">
    ...
    <div class="col">
        ...
        <br/>
        <asp:TextBox ID="txbStatFour" runat="server" class="tbxInfo">Groupe Fournisseur</asp:TextBox>
        <br/>
        <br/> 
        <asp:Label ID="lblClsABCFour" runat="server" Text="Classement ABC Fournisseur" class="lblInfo"></asp:Label>
        <br/>
        <asp:TextBox ID="tbxClsABCFour" runat="server" class="tbxInfo">Classement ABC Fournisseur</asp:TextBox>
        <br/>
        <br/>
        <asp:Label ID="lblNoteFour" runat="server" Text="Note Fournisseur en %" class="lblInfo"></asp:Label>
        <br/>
        <asp:TextBox ID="tbxNoteFour" runat="server" class="tbxInfo">Note Fournisseur en %</asp:TextBox>
        <br/>
        <br/>
        <br/>
        <br/>
    ...
    <div class="col">
        <br/>
        <br/>
        <asp:Label ID="lblMinCmdUc" runat="server" Text="Minimum commande en UC" class="lblInfo"></asp:Label>
        <br/>
        <asp:TextBox ID="tbxMinCmdUc" runat="server" class="tbxInfo">Minimum commande en UC</asp:TextBox>
        <br/>
        <br/>
        <asp:Label ID="lblMinCmdVal" runat="server" Text="Minimum Commande en Valeur" class="lblInfo"></asp:Label>
        <br/>
        <asp:TextBox ID="tbxMinCmdVal" runat="server" class="tbxInfo">Minimum Commande en Valeur</asp:TextBox>
        <br/>
        <br/>
        <asp:Label ID="lblAcht" runat="server" Text="Acheteur" class="lblInfo"></asp:Label>
        <br/>
        <asp:TextBox ID="tbxAcht" runat="server" class="tbxInfo">Acheteur</asp:TextBox>
        <br/>
        <br/>
        <asp:Label ID="lblApvs" runat="server" Text="Approvisionneur" class="lblInfo"></asp:Label>
        <br/>
        <asp:TextBox ID="tbxApvs" runat="server" class="tbxInfo">Approvisionneur</asp:TextBox>
        <br/>
		<br/>
        <br/>
        <br/>
